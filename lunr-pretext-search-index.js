...
},
{
  "id": "p-235",
  "level": "2",
  "url": "s_proof_technique.html#p-235",
...
},
{
  "id": "p-236",
  "level": "2",
  "url": "s_proof_technique.html#p-236",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-238",
  "level": "2",
  "url": "s_proof_technique.html#p-238",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-247",
  "level": "2",
  "url": "s_proof_technique.html#p-247",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "1.2.3.2",
  "title": "",
  "body": "  Consider the matrix    7  0  -6    -7  -9  6    5  2  -5    (a) On the matrix above, perform the row operation . The new matrix is:                   (b) On the original matrix, perform the row operation . The new matrix is:                   (c) On the original matrix, perform the row operation . The new matrix is:                                                                                                                                                              "
},
{
  "id": "exercise-29",
  "level": "2",
...
},
{
  "id": "proof-17",
  "level": "2",
  "url": "s_invertible_matrices.html#proof-17",
  "type": "Proof",
  "number": "2.3.1.4",
  "title": "",
...
},
{
  "id": "p-1308",
  "level": "2",
  "url": "s_invertibility_theorem.html#p-1308",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "57 "
...
{
  "id": "eg_vector_linear_combination",
  "level": "2",
...
},
{
  "id": "proof-41",
  "level": "2",
  "url": "s_vectorspace.html#proof-41",
  "type": "Proof",
  "number": "3.1.3.1",
  "title": "",
...
},
{
  ...
  "body": " Matrix transformations  matrix transformation    the matrix transformation associated to    Let be an matrix. The matrix transformation associated to is the function defined as follows: . In other words, given input , the output is defined as . The matrix is called the standard matrix of the transformation .   "
},
{
...
},
{
  "id": "example-49",
  "level": "2",
  "url": "s_transformation.html#example-49",
  "type": "Example",
  "number": "3.2.15",
...
},
{
  ...
  "body": " Lines and planes   Recall that a line in that passes through the origin can be expressed as the set of solutions to an equation of the form . Similarly, a plane in that passes through the origin can be expressed as the the set of solutions to an equation of the form . (See .) We see immediately that both objects can be described as the set of solutions to a certain homogenous matrix equation : . We conclude from that lines in , and planes in , are subspaces, as long as they pass through the origin .  On the other hand, a line or plane that does not pass through the origin is not a subspace, since it does not contain the zero vector.  Question: How do we classify all subspaces of of ? We will be able to answer this easily with dimension theory. (See .)   "
},
{
  "id": "d_trace",
  "level": "2",
...
},
{
  ...
  "body": " Function subspaces  function space continuous  function space  function space infinitely differentiable  function space polynomial  polynomial   Let be a nondegenerate interval.   We denote by the set of all continuous functions on : , .    Fix . A function is on X if is -times differentiable on and its -th derivative is continuous. The set of all functions on is denoted .    A function is on X if is infinitely differentiable on . The set of all functions on is denoted .    A polynomial on of degree at most is a polynomial of the form , where . (See , and in particular for more details about polynomials.) Recall that if , we call the the degree of , denoted .  The set of polynomials of degree at most on is denoted ; the set of all polynomials on is denoted . When , we shorten the notation to and .      "
},
{
  ...
  "number": "3.3.21",
  "title": "Function subspaces.",
  "body": " Function subspaces   Let be an interval. The sets are all subspaces of . Thus we have the following chain of subspaces: .    The proof amounts to the following observations:   The zero function is an element of all of these sets: the zero function is continuous, , , a polynomial, .    If and both satisfy one of these properties (continuous, , , polynomial, ), then so does for any .   The second, closed under linear combinations observation is easily seen for and ( , the sum of two polynomials of degree at most is clearly a polynomial of degree at most ); for the other spaces, this is a result of calculus properties to the effect that adding and scaling functions preserves continuity and differentiability.  Lastly, that each subset relation holds in the given chain follows from similar observations: polynomials are infinitely differentiable, differentiable functions are continuous, .   "
},
{
  "id": "th_poly_equality",
  "level": "2",
...
},
{
  ...
  "number": "3.4.3.12",
  "title": "",
  "body": "  Let be the linear transformation defined by Find a vector that is NOT in the image of .    and find a different, nonzero vector that IS in the image of .   .      "
},
{
  "id": "exercise-212",
  "level": "2",
...
},
{
  ...
  "number": "3.8.4.3",
  "title": "",
  "body": "  Are the following statements true or false?    If and are subspaces of of the same dimension, then .    If span{ }, then .    If the set of vectors spans a subspace , then vectors can be added to to create a basis for    If the set of vectors is linearly independent in a subspace then vectors can be added to to create a basis for    If the set of vectors is linearly independent in a subspace then vectors can be removed from to create a basis for .        "
},
{
  "id": "exercise-288",
  "level": "2",
...
},
{
  "id": "p-3153",
  "level": "2",
  "url": "s_orthogonal_projection.html#p-3153",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "p-3158",
  "level": "2",
  "url": "s_orthogonal_projection.html#p-3158",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "least-squares "
